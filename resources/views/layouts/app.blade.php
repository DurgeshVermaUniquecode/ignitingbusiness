...
<html lang="en" class="layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-skin="default" data-template="horizontal-menu-template" data-bs-theme="light">
  <head>
    <meta charset="utf-8" />
          ...
          <div class="container-xxl">
            <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4 ms-0">
              <a href="index.html" class="app-brand-link">
                ...
                <span class="app-brand-text demo menu-text fw-bold text-heading">{{ config('app.name') }}</span>
              </a>
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  <a
                    ...
                    <div class="avatar avatar-online">
                      <img src="{{asset('images/profile/'.auth()->user()->profile_pic)}}" onerror="this.onerror=null;this.src='{{ asset($profile_image) }}';" alt class="rounded-circle" />
                    </div>
                  </a>
                      ...
                      <a class="dropdown-item mt-0" href="pages-account-settings-account.html">
                        <div class="d-flex align-items-center">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-body-secondary">{{ Auth::user()->code }}</small><br>
                            <small class="text-body-secondary">{{ Auth::user()->roles->role_name }}</small>
                          </div>
                        </div>
                      </a>
                    </li>
              ...
              <div class="container-xxl">
                <div
                  ...
                  <div class="text-body">
                    ...
                    , made with ❤️ by <a href="https://pixinvent.com" target="_blank" class="footer-link">{{ config('app.name') }}</a>
                  </div>
                  <div class="d-none d-lg-inline-block">
                    <a href="{{url('privacy')}}" target="_blank" class="footer-link d-none d-sm-inline-block"
                      >Privacy</a
                    >
                  </div>
                </div>
