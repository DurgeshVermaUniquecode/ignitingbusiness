...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" sizes="56x56" href="{{asset('front/assets/images/fav-icon/icon.png')}}">
    <!-- bootstrap CSS -->
        ...
        <div class="row align-items-center">
            <div class="col-lg-2">
                <div class="header-logo">
                    ...
                    <a class="active_sticky" href="{{url('/')}}"><img src="{{asset('images/'.config('app.logo'))}}" width="90" alt="logo"></a>
                </div>
            </div>
            <div class="col-lg-7">
            ...
            <div class="col-lg-3">  
                <div class="consalt_header-right">
                    ...
                    <div class="header-button style_two">
                        <a href="{{url('contact-us')}}">Get Started Now</a>
                    </div>
            ...
            <div class="sidebar-textwidget">
                ...
                <div class="sidebar-info-contents">
                    <div class="content-inner">
                        <div class="nav-logo">
                            <a href="index.html"><img src="{{asset('front/assets/images/logo.png')}}" alt="sid img" ></a>
                        </div>
                        <div class="row padding-two">
                            <div class="col-lg-6">
                                <div class="content-thumb-box">
                                    <img src="{{asset('front/assets/images/home_one/team.jpg')}}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <div class="content-thumb-box">
                                    <img src="{{asset('front/assets/images/home_one/team1.jpg')}}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <div class="content-thumb-box">
                                    <img src="{{asset('front/assets/images/home_one/team2.jpg')}}" alt="">
                                </div>
                            </div>
                            <div class="col-lg-6 ">
                                <div class="content-thumb-box">
...
<!--==================================================-->
<section class="hero_slider style_sixs boxed">
    <div class="swiper slider-active">
        <div class="swiper-wrapper">
            <div class="swiper-slide">
                <div class="main_hero d-flex align-items-center">
                    <div class="container">
                        <div class="row align-items-center">
                            <div class="col-lg-6">
                                <!-- hero content -->
                                <div class="hero_slide_content">
                                    ...
                                    <h1>Achieve Your Goals,<br>Access Tailored Smart<br>Financing</h1>
                                    <p>Our all-in-one personal finance app simplifies budgeting, tracks expenses
                                        and offers smart saving tips.</p>
                                        <!-- slider button -->
                                    <div class="slider_button">
                                        <div class="hero_btn">
                                            <a href="contact.html">Get Started Now <span></span></a>
                                        </div>
                                    </div>
                                    <div class="banner_list">
                                        <ul>
                                            <li><i class="bi bi-check2"></i><span>Expert Services</span></li>
                                            <li><i class="bi bi-check2"></i><span>Fintech Solution</span></li>
                                            <li><i class="bi bi-check2"></i><span>Free Support</span></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div class="hero-thumbs">
                                    <img src="{{asset('front/assets/images/home-six/hero_thumb.png')}}" alt="">
                ...
                <div class="main_hero d-flex align-items-center">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="hero-thumbs">
                                    <img src="{{asset('front/assets/images/home-six/slider%20img%20_1.png')}}" alt="">
                                    <div class="video-icon">
                                        <a class="video-vemo-icon venobox vbox-item" data-vbtype="youtube" data-autoplay="true" href="https://youtu.be/BS4TUd7FJSg">Play</a>
                                    </div>
                                </div>
                ...
                <div class="main_hero d-flex align-items-center">
                    <div class="container">
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-6">
                                <div class="hero-thumbs">
                                    <img src="{{asset('front/assets/images/home-six/slider%20img%20_%202.png')}}" alt="">
                                    <div class="video-icon">
                                        <a class="video-vemo-icon venobox vbox-item" data-vbtype="youtube" data-autoplay="true" href="https://youtu.be/BS4TUd7FJSg">Play</a>
                                    </div>
                                </div>
...
<!--==================================================-->
<!-- Start Consalt Feature Area style Five-->
<!--==================================================-->
<section class="feature_area style_two style_five">
    <div class="container">
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <!-- feature item -->
                <div class="feature_item  style_two style_four style_five">
                    <div class="feature_icon">
                        <img src="{{asset('front/assets/images/home-five/feature1.png')}}" alt="">
                    </div>
                    <div class="feature_content">
                        <h3>24/7 Customer Support</h3>
                        <p>Continually plagiarize virtual web services
                            with resource maximizing action items
                            Globally build front-end..</p>
                        <div class="feature_btns">
                            <a href="service-details.html"><i class="bi bi-plus"></i> <span>Learn More</span> </a>
                        </div>
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="feature_item  style_two style_four style_five">
                    <div class="feature_icon">
                        <img src="{{asset('front/assets/images/home-five/feature2.png')}}" alt="">
                    </div>
                    <div class="feature_content">
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="feature_item  style_two style_four style_five">
                    <div class="feature_icon">
                        <img src="{{asset('front/assets/images/home-five/feature3.png')}}" alt="">
                    </div>
                    <div class="feature_content">
                        <h3>Creative Idea</h3>
                        <p>Continually plagiarize virtual web services
...
<!--==================================================-->
<!-- End Consalt Feature Area Style Five -->
<!--==================================================-->


<!--==================================================-->
<!-- Start Consalt About Area Style six-->
<!--==================================================-->
<section class="about_area style_two style_sixs boxed">
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12">
                <div class="about_thumb">
                    <img src="{{asset('front/assets/images/home-six/about_img.png')}}" alt="">
                    <div class="about_experience">
                        <div class="about_experience_content">
            ...
            <div class="col-lg-6 col-md-12">
                <div class="about_right">
                    <div class="section_title home_five home_six">
                        <h4>ABAUT CONSALT</h4>
                        <h1>Fintech's Impact on Everyday</h1>
                        <h1>Transactions</h1>
                    ...
                    <div class="about_list style_sixs">
                        <ul>
                            <li><img src="{{asset('front/assets/images/home-six/star.png')}}" alt="">Get top 3% experts for your project</li>
                            <li><img src="{{asset('front/assets/images/home-six/star.png')}}" alt="">Protected payments system</li>
                            <li><img src="{{asset('front/assets/images/home-six/star.png')}}" alt="">Seamless searching</li>
                        </ul>
                    </div>
                    <div class="about_button">
                        <div class="about_btn home_six_btn animate_buton">
                            <a href="about.html">Get Start Now<span></span></a>
                        </div>
                    </div>
                    <div class="about_reviews">
                        <div class="review_client">
                            <a href="#"><img src="{{asset('front/assets/images/home-six/about_atr.png')}}" alt=""><i class="flaticon flaticon-right-arrow"></i></a>
                        </div>
...
<!--==================================================-->
<!-- Start Consalt Pricing Area Style Three-->
<!--==================================================-->
<section class="pricing_area style_three">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section_title home_five home_six">
                    <h4>PRICING PLAN</h4>
                    <h1>We Offer The Best Pricing</h1>
                </div>  
            </div>
        </div>   
        <div class="row">
                                ...
                                <div class="col-lg-4 col-md-6">
                                    <div class="pricing-single-item">
                                        ...
                                        <div class="pricing-item-text">                     
                                            <span class="tk">$69.55</span>                                  
                                            <span class="month">PER MONTH</span>
                                        </div>
                                        <div class="pricing-body">
                                            <div class="pricing-feature">
                                                <ul>
                                                    <li>10 PPC Campaigns Per Day</li>
                                                    <li>The point of using lorem</li>
                                                    <li class="list_line">Premium Phone Support</li>
                                                    <li class="list_line">Unlimited Bandwidth</li>
                                                    <li>The point of using lorem</li>
                                                </ul>
                                            </div>
                                        </div>                                  
                                        <div class="consalt_btn style_two">
...
<!--==================================================-->
<!-- End Consalt Pricing Area Style Three-->
<!--==================================================-->


<!--==================================================-->
<!-- Start Consalt Team Area style Fvie-->
<!--==================================================-->
<section class="team_area style_two style_five boxed">
    <div class="container">
        <div class="row">
            <div class="col-lg-4">
                <div class="section_title style_two home_five home_six">
                    <h4>Our Team</h4>
                    <h1>Our Expert Team</h1>
                    <h1>Consult</h1>
                    <p>Our all personal finance simplifie expenses
                        and offers smart saving tips.</p>

                </div>  
                <div class="consalt_btn home_five animate_buton">
                    <a href="team.html">More Team Members <span style="top: 32.25px; left: -10px;"></span></a>
                </div>
                <h5 class="team_des">Want to join our team for better future?</h5>
                <a class="team_join" href="team.html">Join Now</a>
            </div>
            <div class="col-lg-8">
                <div class="row">
                    <div class="team_list owl-carousel">
                        <div class="col-lg-12">
                            <div class="single-team_item style_two style_three style_four style_five">
                                <div class="team_thumb">
                                    <img src="{{asset('front/assets/images/home-six/theam_img1.png')}}" alt="">
                        ...
                        <div class="col-lg-12">
                            <div class="single-team_item style_two style_three style_four style_five">
                                <div class="team_thumb">
                                    <img src="{{asset('front/assets/images/home-six/team_img2.png')}}" alt="">
                                    
                                </div>
                                <div class="team-content">
                                    <h3><a href="#">Sonalika Mony</a></h3>
                                    <span>Lead Developer</span>
                                    <div class="team-social-four">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-pinterest-p"></i></a></li>
                        ...
                        <div class="col-lg-12">
                            <div class="single-team_item style_two style_three style_four style_five">
                                <div class="team_thumb">
                                    <img src="{{asset('front/assets/images/home-six/team_img3.png')}}" alt="">
                                    
                                </div>
                                <div class="team-content">
                                    <h3><a href="#">Abu Taleb</a></h3>
                                    <span>Lead Developer</span>
                                    <div class="team-social-four">
                                        <ul>
                                            <li><a href="#"><i class="fab fa-pinterest-p"></i></a></li>
    ...
    <div class="team_shpe_arrow bounce-animate">
        <img src="{{asset('front/assets/images/home-six/arrow.png')}}" alt="">
    </div>
</section>
<!--==================================================-->
...
<!--==================================================-->
<!-- Start Consalt case study Area style_three -->
<!--==================================================-->
<section class="case-study-area style_three style_four boxed">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <!-- section title -->
                <div class="section_title home_five home_six text-center ">
                    <h4>OUR SUCCESSFUL PROJECTS</h4>
                    <h1>Our Latest Projects</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="case_study3 owl-carousel">
                <div class="col-lg-12">
                    <div class="case-study-single-box style_three">
                        <div class="case-study-thumb">
                            <img src="{{asset('front/assets/images/home-six/case_img1.png')}}" alt="">
                            <div class="case-study-content">
                                <p>Technology</p>
                                <h3><a href="portfolio.html">Business Implement</a></h3>                                
                                <div class="consalt_btn home_five animate_buton">
                                    <a href="protfolio-details.html">Laren More <i class="flaticon flaticon-right-arrow"></i><span></span></a>
                                </div>
                            </div>
                        </div>                  
                    </div>
                ...
                <div class="col-lg-12">
                    <div class="case-study-single-box style_three">
                        <div class="case-study-thumb">
                            <img src="{{asset('front/assets/images/home-six/case_img3.png')}}" alt="">
                            <div class="case-study-content">
                                <p>Modern Strategy</p>
                                <h3><a href="portfolio.html">InsightTech Consulting</a></h3>                                
                                <div class="consalt_btn home_five animate_buton">
                                    <a href="protfolio-details.html">Laren More <i class="flaticon flaticon-right-arrow"></i><span></span></a>
                                </div>
                            </div>
                ...
                <div class="col-lg-12">
                    <div class="case-study-single-box style_three">
                        <div class="case-study-thumb">
                            <img src="{{asset('front/assets/images/home-six/case_img2.png')}}" alt="">
                            <div class="case-study-content">
                                <p>Technology</p>
                                <h3><a href="portfolio.html">Business Implement</a></h3>                                
                                <div class="consalt_btn home_five animate_buton">
...
<!--==================================================-->
<!-- End Consalt case study Area style_three-->
<!--==================================================-->
...
<!--==================================================-->
<div class="marquee_area style_three">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row">
            <div class="blog_list2 owl-carousel">
                <div class="col-lg-12">
                    <div class="single-blog-box">
                        <div class="single-blog-thumb">
                            <img src="{{asset('front/assets/images/home-five/blog1.png')}}" alt="">                            
                        </div>
                ...
                <div class="col-lg-12">
                    <div class="single-blog-box">
                        <div class="single-blog-thumb">
                            <img src="{{asset('front/assets/images/home-five/blog2.png')}}" alt="">                            
                        </div>
                        <div class="blog-content">
                            <div class="meta-blog">
                ...
                <div class="col-lg-12">
                    <div class="single-blog-box">
                        <div class="single-blog-thumb">
                            <img src="{{asset('front/assets/images/home-five/blog3.png')}}" alt="">                            
                        </div>
                        <div class="blog-content">
                            <div class="meta-blog">
                                <p><span class="solution">business</span>20 Jan, 2024</p>
